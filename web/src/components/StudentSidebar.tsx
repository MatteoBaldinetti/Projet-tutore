...
const IconDashboard = () => (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" className="w-5 h-5 shrink-0">
...
const IconDoor = () => (
    <svg width="16" height="18" viewBox="0 0 16 18" fill="none" className="w-5 h-5 shrink-0">
...
const IconCalendar = () => (
    <svg width="18" height="20" viewBox="0 0 18 20" fill="none" className="w-5 h-5 shrink-0">
...
const IconUser = () => (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" className="w-5 h-5 shrink-0">
...
const IconWarning = () => (
    <svg width="18" height="16" viewBox="0 0 18 16" fill="none" className="w-5 h-5 shrink-0">
...
const IconChevron = ({ open }: { open: boolean }) => (
    <svg width="12" height="8" viewBox="0 0 12 8" fill="none" className={`w-3 h-3 shrink-0 transition-transform duration-200 ${open ? "rotate-180" : ""}`}>
...
const navGroups: NavGroup[] = [
    {
        ...
        icon: <IconBox />,
        items: [
            { label: "Catalogue matériel", href: "/student/materiel-list", icon: <IconBox /> },
        ],
    },
    {
        label: "Salles",
        icon: <IconDoor />,
        items: [
            { label: "Catalogue salles", href: "/student/room-list", icon: <IconDoor /> },
        ],
    },
    {
        ...
        icon: <IconCalendar />,
        items: [
            { label: "Mes réservations", href: "/student/my-reservations", icon: <IconCalendar /> },
        ],
    },
];
...
function StudentSidebar() {
    ...
    const simpleLinks = [
        { href: "/student/dashboard", label: "Tableau de bord", icon: <IconDashboard /> },
        { href: "/student/notifications", label: "Notifications", icon: <IconBell /> },
        { href: "/student/report", label: "Signaler un problème", icon: <IconWarning /> },
        { href: "/student/profile", label: "Mon profil", icon: <IconUser /> },
    ];
