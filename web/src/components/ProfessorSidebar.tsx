...
const navGroups: NavGroup[] = [
    {
        ...
        icon: <IconCalendar />,
        items: [
            { label: "À valider",        href: "/professor/reservations/pending",  icon: <IconCalendar /> },
            { label: "Toutes",           href: "/professor/reservations",          icon: <IconCalendar /> },
        ],
    },
    {
        ...
        icon: <IconBox />,
        items: [
            { label: "Mes matériels",    href: "/professor/resources/items",       icon: <IconBox /> },
            { label: "Mes salles",       href: "/professor/resources/classrooms",  icon: <IconDoor /> },
        ],
    },
];
...
function ProfessorSidebar() {
    ...
    const simpleLinks = [
        { href: "/professor/dashboard",     label: "Tableau de bord",       icon: <IconDashboard /> },
        { href: "/professor/notifications", label: "Notifications",          icon: <IconBell /> },
        { href: "/professor/reports",       label: "Signalements reçus",    icon: <IconWarning /> },
