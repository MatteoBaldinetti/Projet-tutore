...
const IconDashboard = () => (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 shrink-0">
...
const IconCalendar = () => (
    <svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 shrink-0">
...
const IconUser = () => (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 shrink-0">
...
const IconDoor = () => (
    <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 shrink-0">
...
const IconTag = () => (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 shrink-0">
        <path d="M10.55 18L0 7.45V0H7.45L18 10.55L10.55 18ZM10.55 15.875L15.875 10.55L6.625 1.3H1.3V6.625L10.55 15.875ZM3.5 5C3.917 5 4.271 4.854 4.563 4.563C4.854 4.271 5 3.917 5 3.5C5 3.083 4.854 2.729 4.563 2.438C4.271 2.146 3.917 2 3.5 2C3.083 2 2.729 2.146 2.438 2.438C2.146 2.729 2 3.083 2 3.5C2 3.917 2.146 4.271 2.438 4.563C2.729 4.854 3.083 5 3.5 5Z" fill="currentColor" />
    </svg>
);

const IconWarning = () => (
    <svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 shrink-0">
...
const IconBell = () => (
    <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 shrink-0">
        <path d="M0 15V13H2V7C2 5.617 2.417 4.387 3.25 3.312C4.083 2.238 5.167 1.533 6.5 1.2V0.5C6.5 0.217 6.596 -0.021 6.788 0.213C6.979 0.104 7.217 0 7.5 0H8.5C8.783 0 9.021 0.104 9.213 0.213C9.404 -0.021 9.5 0.217 9.5 0.5V1.2C10.833 1.533 11.917 2.238 12.75 3.312C13.583 4.387 14 5.617 14 7V13H16V15H0ZM8 18C7.45 18 6.979 17.804 6.588 17.413C6.196 17.021 6 16.55 6 16H10C10 16.55 9.804 17.021 9.413 17.413C9.021 17.804 8.55 18 8 18ZM4 13H12V7C12 5.9 11.608 4.958 10.825 4.175C10.042 3.392 9.1 3 8 3C6.9 3 5.958 3.392 5.175 4.175C4.392 4.958 4 5.9 4 7V13Z" fill="currentColor" />
    </svg>
);

const IconBook = () => (
    <svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 shrink-0">
        <path d="M1 16C0.717 16 0.479 15.904 0.288 15.712C0.096 15.521 0 15.283 0 15V3C0 2.717 0.096 2.479 0.288 2.288C0.479 2.096 0.717 2 1 2H5.175C5.425 1.417 5.821 0.938 6.363 0.563C6.904 0.188 7.517 0 8.2 0C8.883 0 9.5 0.188 10.05 0.563C10.6 0.938 10.992 1.417 11.225 2H15C15.283 2 15.521 2.096 15.712 2.288C15.904 2.479 16 2.717 16 3V15C16 15.283 15.904 15.521 15.712 15.712C15.521 15.904 15.283 16 15 16H1ZM1 14H15V4H1V14ZM8 3C8.283 3 8.521 2.904 8.712 2.713C8.904 2.521 9 2.283 9 2C9 1.717 8.904 1.479 8.712 1.287C8.521 1.096 8.283 1 8 1C7.717 1 7.479 1.096 7.287 1.287C7.096 1.479 7 1.717 7 2C7 2.283 7.096 2.521 7.287 2.713C7.479 2.904 7.717 3 8 3ZM3 12H9V10H3V12ZM3 8H13V6H3V8Z" fill="currentColor" />
    </svg>
);
...
const navGroups: NavGroup[] = [
    ...
    },
    {
        ...
        icon: <IconBook />,
        items: [
            { label: "Matières", href: "/admin/manage-subjects", icon: <IconBook /> },
        ],
    },
    {
        label: "Réservations",
        icon: <IconCalendar />,
        items: [
            { label: "Réservations", href: "/admin/manage-reservations", icon: <IconCalendar /> },
        ],
    },
    {
        label: "Incidents",
        icon: <IconWarning />,
        items: [
            { label: "Signalements", href: "/admin/manage-reports", icon: <IconWarning /> },
        ],
    },
    {
        label: "Communication",
        icon: <IconBell />,
        items: [
            { label: "Notifications", href: "/admin/manage-notifications", icon: <IconBell /> },
        ],
    },
];
        ...
        <div>
            <button
                ...
                className={`w-full flex items-center justify-between gap-2 pl-3 pr-3 py-2.5 rounded-lg transition-colors
                    ${isGroupActive ? "text-[#3A8C85]" : "hover:text-[#3A8C85] hover:bg-[#3A8C851A]"}`}
            >
