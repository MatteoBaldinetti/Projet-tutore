...
const IconTag = () => (
  ...
  >
    <path
      d="M10.55 18L0 7.45V0H7.45L18 10.55L10.55 18ZM10.55 15.875L15.875 10.55L6.625 1.3H1.3V6.625L10.55 15.875ZM3.5 5C3.917 5 4.271 4.854 4.563 4.563C4.854 4.271 5 3.917 5 3.5C5 3.083 4.854 2.729 4.563 2.438C4.271 2.146 3.917 2 3.5 2C3.083 2 2.729 2.146 2.438 2.438C2.146 2.729 2 3.083 2 3.5C2 3.917 2.146 4.271 2.438 4.563C2.729 4.854 3.083 5 3.5 5Z"
      fill="currentColor"
    />
  </svg>
);
...
const IconBook = () => (
  ...
  >
    <path
      d="M1 16C0.717 16 0.479 15.904 0.288 15.712C0.096 15.521 0 15.283 0 15V3C0 2.717 0.096 2.479 0.288 2.288C0.479 2.096 0.717 2 1 2H5.175C5.425 1.417 5.821 0.938 6.363 0.563C6.904 0.188 7.517 0 8.2 0C8.883 0 9.5 0.188 10.05 0.563C10.6 0.938 10.992 1.417 11.225 2H15C15.283 2 15.521 2.096 15.712 2.288C15.904 2.479 16 2.717 16 3V15C16 15.283 15.904 15.521 15.712 15.712C15.521 15.904 15.283 16 15 16H1ZM1 14H15V4H1V14ZM8 3C8.283 3 8.521 2.904 8.712 2.713C8.904 2.521 9 2.283 9 2C9 1.717 8.904 1.479 8.712 1.287C8.521 1.096 8.283 1 8 1C7.717 1 7.479 1.096 7.287 1.287C7.096 1.479 7 1.717 7 2C7 2.283 7.096 2.521 7.287 2.713C7.479 2.904 7.717 3 8 3ZM3 12H9V10H3V12ZM3 8H13V6H3V8Z"
      fill="currentColor"
    />
  </svg>
);
