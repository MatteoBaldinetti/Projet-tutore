    ...
    return (
        <aside className="h-screen bg-[#39393A] text-[#CBD5E1]">
            <nav className="p-4 space-y-3">
                ...
                <div className="border-l-4 border-[#00000000] rounded-r-lg hover:border-[#3A8C85] hover:bg-[#3A8C851A] hover:text-[#3A8C85] transition-colors">
                    <a href="/admin/manage-students" className="flex items-center gap-2 pl-3 py-3">
                        <svg
                            width="16"
                            height="16"
                            viewBox="0 0 16 16"
                ...
                <div className="border-l-4 border-[#00000000] rounded-r-lg hover:border-[#3A8C85] hover:bg-[#3A8C851A] hover:text-[#3A8C85] transition-colors">
                    <a href="/admin/manage-professors" className="flex items-center gap-2 pl-3 py-3">
                        <svg
                            width="16"
                            height="16"
                            viewBox="0 0 16 16"
                ...
                <div className="border-l-4 border-[#00000000] rounded-r-lg hover:border-[#3A8C85] hover:bg-[#3A8C851A] hover:text-[#3A8C85] transition-colors">
                    <a href="/admin/manage-subjects" className="flex items-center gap-2 pl-3 py-3">
                        <svg
                            width="16"
                            height="16"
                            viewBox="0 0 16 16"
