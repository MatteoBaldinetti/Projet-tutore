      ...
      <Router>
        <AuthProvider>
          <Routes>
            ...
            />
            <Route
              path="/professor/reservations/pending"
              element={<ProfessorPendingReservations />}
            />
            <Route
            ...
            />
            <Route
              path="/professor/resources/items"
              element={<ProfessorResources type="items" />}
            />
            <Route
              path="/professor/resources/classrooms"
              element={<ProfessorResources type="classrooms" />}
            />
            ...
            <Route
              path="/student/room-reservation/:id"
